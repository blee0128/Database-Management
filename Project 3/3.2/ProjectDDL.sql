...
FOREIGN KEY (Posting_user) REFERENCES TwitterUser(Screen_name) ON UPDATE CASCADE ON DELETE CASCADE);
...
FOREIGN KEY (Tid) REFERENCES tweet(Tid) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY (Screen_name) REFERENCES TwitterUser(Screen_name) ON UPDATE CASCADE ON DELETE CASCADE);